...
ActiveRecord::Schema.define(version: 2019_12_13_123801) do
  ...
  add_foreign_key "whitehall_imported_assets", "file_attachment_revisions", on_delete: :cascade
  add_foreign_key "whitehall_imported_assets", "image_revisions", on_delete: :cascade
