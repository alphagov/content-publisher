  ...
  class NewDocumentController < ApplicationController
    ...
    def choose_document_type
      unless params[:supertype]
        redirect_to versioned_new_document_path,
    ...
    def create
      unless params[:document_type]
        redirect_to versioned_choose_document_type_path(supertype: params[:supertype]),
      ...
      document = Versioned::Document.create_initial(
