...
RSpec.describe Versioned::EditionUrl do
  let(:edition) do
    build(:versioned_edition,
          base_path: "/foo",
  ...
  describe "#public_url" do
    it "returns the URL" do
      url = Versioned::EditionUrl.new(edition).public_url
      expect(url).to eq("https://www.test.gov.uk/foo")
    end

    it "returns nil without a base_path" do
      edition = build(:versioned_edition, base_path: nil)
      url = Versioned::EditionUrl.new(edition).public_url
  ...
  describe "#preview_url" do
    it "returns the URL" do
      url = Versioned::EditionUrl.new(edition).preview_url
  ...
  describe "#secret_preview_url" do
    it "returns the URL" do
      url = Versioned::EditionUrl.new(edition).secret_preview_url
