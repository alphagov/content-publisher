RSpec.describe Requirements::Form::ImageMetadataChecker do
  describe ".call" do
    ...
    it "returns an issue if the alt text is too long" do
      ...
      expect(issues).to have_issue(:image_alt_text, :too_long, max_length:)
    end
    ...
    it "returns an issue if the caption is too long" do
      ...
      expect(issues).to have_issue(:image_caption, :too_long, max_length:)
    end
    ...
    it "returns an issue if the credit is too long" do
      ...
      expect(issues).to have_issue(:image_credit, :too_long, max_length:)
    end
  end
end
