...
RSpec.describe Versioned::ContentRevision do
  describe "#different_to?" do
    it "is true when content data is different" do
      revision1 = build(:versioned_content_revision,
                        title: "Test",
                        contents: { "body" => "Content" })
      revision2 = build(:versioned_content_revision,
                        title: "Test",
  ...
  describe "#build_revision_update" do
    let(:existing_revision) { create(:versioned_content_revision) }
