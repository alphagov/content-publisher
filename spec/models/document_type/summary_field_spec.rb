...
RSpec.describe DocumentType::SummaryField do
  describe "#payload" do
    it "returns a hash with a 'description' / summary" do
      ...
      payload = DocumentType::SummaryField.new.payload(edition)
  ...
  describe "#updater_params" do
    it "returns a hash of the stripped summary" do
      ...
      updater_params = DocumentType::SummaryField.new.updater_params(edition, params)
  ...
  describe "#pre_update_issues" do
    ...
    it "returns no issues if there are none" do
      ...
      issues = DocumentType::SummaryField.new.pre_update_issues(edition, params)
  ...
  describe "#pre_preview_issues" do
    ...
    it "delegates to #pre_update_issues" do
      field = DocumentType::SummaryField.new
  ...
  describe "#pre_publish_issues" do
    ...
    it "returns no issues if there are none" do
      issues = DocumentType::SummaryField.new.pre_publish_issues(edition)
      expect(issues).to be_empty
    end
