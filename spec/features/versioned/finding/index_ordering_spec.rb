...
RSpec.feature "User orders documents" do
  ...
  def given_there_are_some_documents
    @most_recent = create(:versioned_edition, title: "Most recent", last_edited_at: 1.minute.ago)
    @least_recent = create(:versioned_edition, title: "Least recent", last_edited_at: 2.minutes.ago)
  end
